...
<!--TODO: Enable CASL Permissions   <router-link   v-if="can(item.perm)" :key="item.name" :to="item.href"   :class="['text-gray-600 hover:bg-gray-50 hover:text-gray-900', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md']">-->
                            <router-link   :key="item.name" :to="item.href"   :class="['text-gray-600 hover:bg-gray-50 hover:text-gray-900', 'group flex items-center px-2 py-2 text-sm font-medium rounded-md']">
...
import {
  ...
  CreditCardIcon,
  Squares2X2Icon,
  DocumentDuplicateIcon, CogIcon, UsersIcon, ArrowsPointingInIcon
...
const navigation = [
    ...
    { name: 'Ingredients', href: '/ingredients', icon: ArrowsPointingInIcon, perm: 'menu_items.view'},
